...
'''
def creat_chapter(packageId):

  url="https://test-codecamp-teaching-system.codemao.cn/packages/"+str(packageId)+"/chapters"
  data=utils.read_yaml("chapter.yaml")
  headers = {
